...
class NotificationService {
  ...
  Future<bool> initialize() async {
    ...
    if (granted == null || !granted) {
      ...
      print(
        "Notification Permission Denied:local alerts will not be displated ",
      );
      return false;
    }
    return true;
  ...
  Future<void> showBatteryAlert(int percentage) async {
    const android = AndroidNotificationDetails(
      'battery_alerts',
      'Battery Alerts',
      channelDescription: 'Threshold battery notifications',
